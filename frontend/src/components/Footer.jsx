      ...
      <div className="max-w-container-max mx-auto px-margin-desktop flex flex-col md:flex-row justify-between items-center gap-gutter">
        <div className="flex items-center gap-2">
          ...
          <span className="font-label-md text-label-md text-on-surface-variant uppercase tracking-widest">
            Powered by MEW-Multi Emergent Workspace
          </span>
        </div>
        <div className="flex gap-gutter">
          <a className="font-label-md text-label-md text-on-surface-variant hover:text-primary uppercase transition-colors" href="/terms">Terms of Service</a>
          <a className="font-label-md text-label-md text-on-surface-variant hover:text-primary uppercase transition-colors" href="/privacy">Privacy Policy</a>
          <a className="font-label-md text-label-md text-on-surface-variant hover:text-primary uppercase transition-colors" href="mailto:akamutala9@gmail.com">Support</a>
        </div>
        <div className="font-label-md text-label-md text-on-surface-variant">
          © 2026 MEW-Multi Emergent Workspace
        </div>
      </div>
    </footer>
  );
